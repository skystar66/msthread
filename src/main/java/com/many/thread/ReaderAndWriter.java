 ...
 * Created by xuliang on 2017/10/30.
 */
public class ReaderAndWriter<K, V> {
    ...
    private final Lock readLock = lock.readLock(); //读
    private final Lock writeLock = lock.writeLock();//写
...
//    }
    ...
    /*************   这是用tryLock()方法写的  取锁的时候锁被占用就返回false，否则返回true ********************/
    public V put(K key, V value) {
        while (true) {
    ...
    public static void main(String[] args) {
        final ReaderAndWriter<String, Integer> rw = new ReaderAndWriter<String, Integer>(new HashMap<String, Integer>());
